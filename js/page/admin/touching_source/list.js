...
import { destroy, exportFile } from "../../touching_source_model.js";
...
exportBtn.addEventListener('click',async function(){
  if(!format.value) return;
    location.href = REQUEST_BASE_URL + '/controller/admin/touching_source.php?mode=export&format='+format.value
})