...
import { destroy, exportFile } from "../../curse_category_model.js";
...
exportBtn.addEventListener('click',async function(){
  if(!format.value) return;
    location.href = REQUEST_BASE_URL + '/controller/admin/curse_category.php?mode=export&format='+format.value
})