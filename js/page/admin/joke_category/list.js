...
import { destroy, exportFile } from "../../joke_category_model.js";
...
exportBtn.addEventListener('click',async function(){
  if(!format.value) return;
    location.href = REQUEST_BASE_URL + '/controller/admin/joke_category.php?mode=export&format='+format.value
})