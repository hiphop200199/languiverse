...
?>
      ...
      <div id="function">
        ...
        <table>
          ...
          <?php foreach ($list as $k => $v): ?>
              ...
              <td >
                  <?php if($v['editor']==$jokeTagController->data['account']['id']):?>
    ...
    <script src="<?=ROOT.'/js/page/admin/joke_tag/list.js'?>" type="module"></script>
