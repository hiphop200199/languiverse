...
$list = $trendsAgeController->index();
?>
    <div id="backend">
...
?>
      ...
      <div id="function">
       ...
       <td class="operation">
               <?php if($v['editor']==$trendsAgeController->data['account']['id']):?>
    ...
    <script src="<?=ROOT.'/js/page/admin/trends_age/list.js'?>" type="module"></script>
