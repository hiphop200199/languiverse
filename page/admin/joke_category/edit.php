...
if (!preg_match('/^id=\d+$/', $query)) {
  header('Location: ' . ROOT . '/page/admin/joke_category/list.php');
  exit;
}
...
$info = $jokeCategoryController->get($id);
if(empty($info)){
  header('Location: ' . ROOT . '/page/admin/joke_category/list.php');
  exit;
}
...
<section id="main">
    ...
    <script src="<?=ROOT.'/js/page/admin/joke_category/edit.js'?>" type="module"></script>
