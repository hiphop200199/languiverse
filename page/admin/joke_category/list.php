...
$list = $jokeCategoryController->index();
?>
    <div id="backend">
...
?>
      ...
      <div id="function">
       ...
       <td >
               <?php if($v['editor']==$jokeCategoryController->data['account']['id']):?>
    ...
    <script src="<?=ROOT.'/js/page/admin/joke_category/list.js'?>" type="module"></script>
