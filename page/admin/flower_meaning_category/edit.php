...
if (!preg_match('/^id=\d+$/', $query)) {
  header('Location: ' . ROOT . '/page/admin/flower_meaning_category/list.php');
  exit;
}
...
$info = $flowerMeaningCategoryController->get($id);
if(empty($info)){
  header('Location: ' . ROOT . '/page/admin/flower_meaning_category/list.php');
  exit;
}
...
<section id="main">
      <section id="form">
        ...
        <form id="flower-meaning-category-edit">
        <label for="">名稱</label>
    ...
    <script src="<?=ROOT.'/js/page/admin/flower_meaning_category/edit.js'?>" type="module"></script>
