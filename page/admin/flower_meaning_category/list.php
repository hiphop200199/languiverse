...
$list = $flowerMeaningCategoryController->index();
?>
    <div id="backend">
...
?>
      ...
      <div id="function">
        ...
        <table>
          ...
          <?php foreach ($list as $k => $v): ?>
              ...
              <td >
                  <?php if($v['editor']==$flowerMeaningCategoryController->data['account']['id']):?>
    ...
    <script src="<?=ROOT.'/js/page/admin/flower_meaning_category/list.js'?>" type="module"></script>
