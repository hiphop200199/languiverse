  ...
  <section id="main">
    <section id="form">
      ...
      <form id="account-edit">
        <label for="">帳號</label>
        <div> <input type="text" id="account" placeholder="請輸入帳號" value="<?= htmlspecialchars($info['account']); ?>"><label for="" id="account-error" class="error">必填</label></div>
        <label for="">密碼</label>
        <div><span>******</span><button id="password-btn">修改密碼</button></div>
        <label for="">暱稱</label>
        <div><input type="text" id="name" value="<?=htmlspecialchars($info['name'])?>" placeholder="請輸入暱稱"><label for="" id="nickname-error" class="error">必填</label></div>
        <label for="">email</label>
        <div><input type="email" value="<?=htmlspecialchars( $info['email']); ?>" id="email" placeholder="請輸入email"><label for="" id="email-error" class="error">必填</label></div>
