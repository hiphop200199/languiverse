...
if (!preg_match('/^id=\d+$/', $query)) {
  header('Location: ' . ROOT . '/page/admin/curse_category/list.php');
  exit;
}
...
$info = $curseCategoryController->get($id);
if(empty($info)){
  header('Location: ' . ROOT . '/page/admin/curse_category/list.php');
  exit;
}
...
<section id="main">
    ...
    <script src="<?=ROOT.'/js/page/admin/curse_category/edit.js'?>" type="module"></script>
