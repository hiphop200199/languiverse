...
$list = $curseCategoryController->index();
?>
    <div id="backend">
...
?>
        ...
        <table>
          ...
          <tbody>
            ...
            <?php foreach ($list as $k => $v): ?>
              ...
              <td class="operation">
                <?php if($v['editor']==$curseCategoryController->data['account']['id']):?>
    ...
    <script src="<?=ROOT.'/js/page/admin/curse_category/list.js'?>" type="module"></script>
