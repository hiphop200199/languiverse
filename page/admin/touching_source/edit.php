...
if (!preg_match('/^id=\d+$/', $query)) {
  header('Location: ' . ROOT . '/page/admin/touching_source/list.php');
  exit;
}
...
$info = $touchingSourceController->get($id);
if(empty($info)){
  header('Location: ' . ROOT . '/page/admin/touching_source/list.php');
  exit;
}
...
<section id="main">
    ...
    <script src="<?=ROOT.'/js/page/admin/touching_source/edit.js'?>" type="module"></script>
