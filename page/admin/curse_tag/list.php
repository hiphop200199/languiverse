...
?>
        ...
        <table>
          ...
          <tbody>
            ...
            <?php foreach ($list as $k => $v): ?>
              ...
              <td class="operation">
                <?php if($v['editor']==$curseTagController->data['account']['id']):?>
    ...
    <script src="<?=ROOT.'/js/page/admin/curse_tag/list.js'?>" type="module"></script>
